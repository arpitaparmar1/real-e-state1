                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <form action="edit_rent_code.jsp" method="post" enctype="multipart/form-data">
                                <%
                                while(rs2.next())
                                {
                                %>    
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            ...
                                            <input class="form-control" value="<%=rs2.getString(2)%>" type="text" name="pr_name" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a mes here" name="pr_address" style="height: 150px"><%=rs2.getString(5)%></textarea>
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_city" placeholder="Your Name" value="<%=rs2.getString(6)%>">
                                            <label for="name">Enter City</label>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_rent" placeholder="Your Name" value="<%=rs2.getString(7)%>">
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            ...
                                            <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a mes here" name="pr_des" style="height: 150px"><%=rs2.getString(9)%></textarea>
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_size" placeholder="Your Name" value="<%=rs2.getString(10)%>">
