                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <form action="rent_insert_code.jsp" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_name" placeholder="Your Name">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a address here" name="pr_address" style="height: 150px"></textarea>
                                            <label for="message">Enter address</label>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_city" placeholder="Your Name">
                                            <label for="name">Enter City</label>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_rent" placeholder="Your Name">
                                     ...
                                     <div class="col-md-12">
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a mes here" name="pr_des" style="height: 150px"></textarea>
                                            <label for="message">Enter Description</label>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pr_size" placeholder="Your Name">
                                            <label for="name">Enter Size</label>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="file" class="form-control" name="pr_photo" placeholder="Your Name" >
